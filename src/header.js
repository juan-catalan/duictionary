  ...
  return (
    ...
    <nav className='bg-white shadow dark:bg-gray-800'>
      <div className='container px-6 py-4 mx-auto md:flex md:justify-between md:items-center'>
        ...
        <div className='items-center mt-6 lg:mt-0 md:flex'>
          ...
          <div className='flex justify-center md:block'>
            <button type='button' onClick={changeTheme} className='hidden lg:inline pl-4 text-gray-500 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400 focus:outline-none' aria-label='toggle menu'>
              <svg viewBox='0 0 24 24' className='mt-3 w-8 h-8 fill-current'>
                <Iconsvg prop={darkMode} />
              </svg>
            </button>
